...
public class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Document>()
            .HasOne(d => d.Uploader).WithMany(u => u.UploadedDocuments)
            .HasForeignKey(d => d.UploaderId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<Document>()
            .HasOne(d => d.Project).WithMany(p => p.Documents)
            .HasForeignKey(d => d.ProjectId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<Document>()
            .HasOne(d => d.Task).WithMany(t => t.Documents)
            .HasForeignKey(d => d.TaskId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<Document>().HasIndex(d => d.StorageKey).IsUnique();
        modelBuilder.Entity<Document>().HasIndex(d => new { d.UploaderId, d.UploadedDate });
        modelBuilder.Entity<Document>().HasIndex(d => new { d.ProjectId, d.UploadedDate });
        modelBuilder.Entity<Document>().HasIndex(d => d.Category);
        modelBuilder.Entity<Document>().HasIndex(d => d.Status);
        ...
        modelBuilder.Entity<DocumentShare>()
            .HasOne(s => s.RecipientUser).WithMany(u => u.DocumentSharesReceived)
            .HasForeignKey(s => s.RecipientUserId).OnDelete(DeleteBehavior.SetNull);
        modelBuilder.Entity<DocumentShare>()
            .HasOne(s => s.SharedByUser).WithMany(u => u.DocumentSharesCreated)
            .HasForeignKey(s => s.SharedByUserId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<DocumentShare>().HasIndex(s => new { s.DocumentId, s.RecipientUserId, s.RevokedDate });
        ...
        modelBuilder.Entity<DocumentActivity>()
            .HasOne(a => a.ActorUser).WithMany(u => u.DocumentActivities)
            .HasForeignKey(a => a.ActorUserId).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<DocumentActivity>().HasIndex(a => new { a.OccurredDate, a.Action });
